    ...
    return (
        <>
            ...
            <section className="container">
                <div id="section-1-2" className="h-[830px]">
                    <div className="flex items-start gap-[90px] p-[110px]">
                        ...
                        <div className="text pt-[8.5px] flex flex-col gap-[24px]">
                            <h2 className="text-[40px] font-[700] w-[210px] leading-[40px]">Feel free to
                            contact us</h2>

                            <p className="pb-[8px]">Leo morbi faucibus mattis pharetra </p>

                            <div className="flex items-start gap-[11px]">
                                <i className='bx bx-map text-[24px]'></i>
                                <h2 className="text-[20px] relative bottom-[6px] text-[#100E2C] w-[260px] font-[600]">8911 Tanglewood Ave.
                                Capitol Heights, MD 20743</h2>
                            </div>

                            <div className="flex items-start gap-[11px]">
                                <i className='bx bx-phone text-[24px]'></i>
                                <h2 className="text-[20px] relative bottom-[4px] text-[#100E2C] w-[260px] font-[600]">(566) 237-4687</h2>
                            </div>

                            <div className="flex items-start gap-[11px]">
                                <i className='bx bx-phone text-[24px]'></i>
                                <h2 className="text-[20px] relative bottom-[4px] text-[#100E2C] w-[260px] font-[600]">(239) 319-8083</h2>
                            </div>

                            <div className="flex items-start gap-[11px]">
                            <i className='bx bx-envelope text-[24px]' ></i>
                                <h2 className="text-[20px] relative bottom-[4px] text-[#100E2C] w-[260px] font-[600]">moinefou@hotmail.com</h2>
                            </div>
                        </div>
            ...
            {/* SECTION-2 STARTED */}
            <section id="section-2" className="py-[60px]">
                <div className="container">
                    <h2 className="text-center text-[#100E2C] text-[40px] font-[700] pb-[10px]">Our Offices</h2>

                    <p className="pb-[40px] text-center">Pretium interdum risus risus facilisis cras pellentesque ipsum suspendisse </p>
