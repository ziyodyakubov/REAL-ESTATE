        ...
        <>
            ...
            <section id="section-1" className="mb-[60px] sm:mb-[30px] sm:px-[20px]">
                <div className="container">
                    <button className="py-[10px] mb-[16px] sm:mb-[10px] px-[32px] sm:px-[14px] sm:w-[100px] w-[137px] rounded-[6px] cursor-pointer hover:bg-[#8eda53df] active:bg-[#8EDA53] duration-150 transition-all bg-[#8EDA53] sm:text-[14px] text-[20px] text-[#fff]">For sale</button>

                    <div className="flex sm:mb-[20px] items-center mb-[40px] justify-between">
                        <div className="flex flex-col gap-[2px]">
                            <h2 className="text-[50px] sm:text-[16px] text-[#100E2C] font-[600]">Amazing modern apartment</h2>
                            <p className="text-[20px] sm:text-[12px] text-[#0000008a]">43 W. Wellington Road Fairhope, AL 36532</p>
                        </div>


                        <div className="flex flex-col gap-[2px]">
                            <h2 className="text-[50px] sm:text-[16px] font-[600]">$120.000</h2>
                            <p className="text-[20px] sm:text-[12px] text-[#0000008a]">$1200/sq.ft</p>
                        </div>
                    </div>
                    ...
                    <div className="flex sm:flex-col items-center gap-[24px]">
                        ...
                        <div className="flex gap-[24px] flex-col">
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2994.210497847105!2d69.26982307624603!3d41.369511171302264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8d002d934c69%3A0xacd1c867c828dce5!2sYunusobod%20Residence!5e0!3m2!1sen!2s!4v1734938673512!5m2!1sen!2s" className="rounded-[12px] w-[416px] h-[260px] sm:w-[350px] filter grayscale" style={{}} loading="lazy" ></iframe>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="flex sm:flex-col sm:gap-[30px] items-start justify-between">
                        <div className="text sm:w-[350px] w-[856px]">
                            ...
                            <h3 className="text-[28px] font-[600] text-[#100E2C] sm:text-[20px] pb-[15px]">Property details</h3>
                        ...
                        <div className="registration sm:w-[350px] w-[416px] h-[640px] bg-[#100E2C] sm:p-[20px] rounded-[12px] text-[#fff] p-[40px]">
                            <h2 className="text-[28px] font-[700] pb-[10px] sm:pb-[25px]">Contact agent</h2>
            ...
            <section id="section-5" className="mb-[60px] sm:mb-[30px] sm:px-[20px]">
                <div className="container">
                    <h2 className="text-[28px] font-[600] text-[#100E2C] sm:text-[16px] pb-[20px]">Video</h2>
            ...
            <section id="section-6-2" className="mb-[60px] sm:mb-[30px] sm:px-[20px]">
                <div className="container">
                    <h2 className="text-[#100E2C] sm:text-[20px] pb-[5px] text-[50px] font-[700]">Related listings</h2>
                    <p className="text-[16px] font-[400] pb-[40px] sm:text-[14px]">Leo morbi faucibus mattis pharetra tellus velit ultricies duis rhoncus</p>
